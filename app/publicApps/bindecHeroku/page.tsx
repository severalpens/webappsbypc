  ...
  function newQuestion() {
    ...
    switch (difficultyLevel) {
      case 0: // Level1
        ...
        break;
      case 1: // Level2
        newDecimal = Math.floor(Math.random() * 31 + 1);
        break;
      case 2: // Level3
        newDecimal = Math.floor(Math.random() * 63 + 1);
        break;
      case 3: // Level4
        newDecimal = Math.floor(Math.random() * 127 + 1);
        break;
      case 4: // Level5
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">
            Binary to Decimal Skill Tester
          </h1>
          <a
          ...
          <div className="w-full max-w-md">
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
                <div className="mb-6">
                  ...
                  >
                    <option value="Level1">⭐ Level 1 (1-15)</option>
                    <option value="Level2">⭐⭐ Level 2 (1-31)</option>
                    <option value="Level3">⭐⭐⭐ Level 3 (1-63)</option>
                    <option value="Level4">⭐⭐⭐⭐ Level 4 (1-127)</option>
                    <option value="Level5">⭐⭐⭐⭐⭐ Level 5 (1-255)</option>
                  </select>
                </div>
                <div className="mb-6">
                  ...
                  <div className="w-full bg-slate-200 rounded-full h-3 overflow-hidden">
                    <div
                      ...
                      style={{
                        width: `${(progressValue / timeoutSeconds) * 100}%`,
                      }}
                    ></div>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 mb-6 border-2 border-blue-200">
                  <label className="block text-sm font-semibold text-slate-600 mb-3 text-center">
                    Convert this binary:
                  </label>
                  <h1
                    id="bits"
                    className="text-3xl md:text-4xl font-mono font-bold text-center text-slate-800 tracking-wider"
                  >
                    {bits}
                  </h1>
                </div>
                <div className="mb-6">
                  ...
                  <input
                    type="number"
                    id="responseInput"
                    className={`w-full px-4 py-4 text-2xl font-bold border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
                      inputClass === "success"
              ...
              <table id="resultsTable" className="w-full border-collapse">
                <tbody>
                  <tr className="border-b border-slate-200">
                    <th
                      scope="row"
                      className="py-4 text-left font-semibold text-slate-600"
                    >
                      Result
                    </th>
