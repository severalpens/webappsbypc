...
import { createConsentGiven } from "./graphql/mutations";
const client = generateClient();
export default function ConsentGivenCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setIsGiven(initialValues.IsGiven);
    setErrors({});
  };
  const validations = {
    IsGiven: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createConsentGiven.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ConsentGivenCreateForm")}
      {...rest}
    >
      <SwitchField
        label="Is given"
